...
public interface AvailabilityRepository extends JpaRepository<Availability, Long> {
    ...
    @Query("SELECT a FROM Availability a WHERE a.expertId = :expertId AND a.status = 1 AND (a.availableDate > :validDate OR (a.availableDate = :validDate AND a.startTime > :currentTime))")
